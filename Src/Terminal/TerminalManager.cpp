...
void TerminalManager::startShell()
{
    ...
    QTimer::singleShot(200, this, [this]() {
        ...
        m_process->write(" git config --global color.ui always\n");
        m_process->write(" git config --global color.status always\n");
        m_process->write(" git config --global color.diff always\n");
        m_process->write(" git config --global color.branch always\n");
...
void TerminalManager::onReadyReadStandardOutput()
{
    ...
    for (const QString &line : lines) {
        ...
        if (trimmed.contains("##PROMPT##")) continue;
